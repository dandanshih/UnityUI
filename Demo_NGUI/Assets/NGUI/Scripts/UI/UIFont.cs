...
public class UIFont : MonoBehaviour
{
    ...
    { 
        get 
        {
            return UseDynamicFont ? dynamicFontSize : ((mReplacement != null) ? mReplacement.size : charSize);
            //return (mReplacement != null) ? mReplacement.size : mFont.charSize; 
        } 
    }
